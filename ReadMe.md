...
- Author: Long Tan, Chen Xu, Xiuzhen Guo, 
...
## File Structure
* Software includes the files needed for the  speech enhancement of the received encoding signals.
  * 3d Model.stl: The 3D mechanical structure of our device.
    
  * CodeForMoterDriver\moterDriver.ino: Control driver code for beam steering.
